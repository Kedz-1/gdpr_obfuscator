...
@mock_aws
def test_obfuscation_tool_obfuscates_for_one_field(csv_example):
...
@mock_aws
def test_obfuscation_tool_obfuscates_for_multiple_fields(pii_fields, csv_example):
...
@mock_aws
def test_obfuscation_tool_error_for_no_pii_fields(csv_example):
...
@mock_aws
def test_obfuscation_tool_obfuscates_parametrize_fields(
    csv_multiple_examples, expected_output, csv_example, pii_fields
):
    ...
    s3_client.put_object(
        Bucket="test-bucket", Key="test-object", Body=csv_multiple_examples
    )
